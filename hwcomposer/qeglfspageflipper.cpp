...
QEglFSPageFlipper::QEglFSPageFlipper(QPlatformScreen *screen)
...
{
    // TODO: Implement support for flipping the buffer to screen
    qWarning("QEglFSPageFlipper::displayBuffer unimplemented in hwcomposer");
    buffer->displayed();
